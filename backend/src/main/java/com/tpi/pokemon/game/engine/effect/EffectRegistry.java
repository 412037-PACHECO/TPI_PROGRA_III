...
public final class EffectRegistry {
    ...
    public static EffectRegistry defaultRegistry() {
        return new EffectRegistry(java.util.List.of(
                ...
                new DiscardHandDrawEffectHandler(),
                new ShuffleHandIntoDeckDrawEffectHandler(),
                new PutDiscardPokemonOnTopDeckEffectHandler(),
                new GreatBallSearchEffectHandler(),
                new EvosodaEvolveEffectHandler(),
                new SuperPotionEffectHandler(),
                new ReturnPokemonToDeckEffectHandler(),
