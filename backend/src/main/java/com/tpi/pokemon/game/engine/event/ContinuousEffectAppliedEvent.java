...
public record ContinuousEffectAppliedEvent(GameId gameId, CardInstanceId sourceCardId, String effectId) implements GameEvent {
    public ContinuousEffectAppliedEvent {
