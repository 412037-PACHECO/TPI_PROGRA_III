...
public record EnergyCostValidatedEvent(GameId gameId, PlayerId playerId, CardInstanceId attackerId, String attackId) implements GameEvent {
    public EnergyCostValidatedEvent {
