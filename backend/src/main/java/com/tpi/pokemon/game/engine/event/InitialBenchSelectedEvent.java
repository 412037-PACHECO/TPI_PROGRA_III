...
public record InitialBenchSelectedEvent(GameId gameId, PlayerId playerId, List<CardInstanceId> cardIds) implements GameEvent {
    public InitialBenchSelectedEvent {
