...
Estado actual del repositorio: documentación base creada y backend Spring Boot implementado incrementalmente hasta Fase 7: catálogo/cache local XY1, Deck Builder backend, modelo interno base de Game State, setup/mulligan inicial, motor de turnos con acciones MAIN estructurales y ataques base con daño/debilidad/resistencia. No existe todavía frontend Angular implementado. Knockout, premios, victoria, condiciones especiales, WebSocket y efectos ejecutables siguen pendientes.
