...
La Fase 11G.4 agrega una verificación documental contra fuente oficial descargada de `pokemontcg.io` v2 para los **146 IDs oficiales** del set `xy1`. La matriz completa de trazabilidad está en:

- [`docs/12-xy1-card-by-card-verification.md`](./12-xy1-card-by-card-verification.md)

Conteos verificados en 11G.4:
...
| Cartas con rules | 31 |
| Cartas con fila detallada previa en esta matriz | 47 |
...
| xy1-115 | Cassius | Trainer | Supporter | none | none | Supporter rule | `Shuffle 1 of your Pokémon and all cards attached to it into your deck.` | SHUFFLE_DECK; MOVE_CARD; CUSTOM_REQUIRED | HIGH | yes | ReturnPokemonToDeckEffectHandler | yes | DATA_IMPORTED; EFFECT_CLASSIFIED; REQUIRES_CUSTOM_HANDLER; EFFECT_MAPPED | no | 11G.3B agrega selección pendiente de Pokémon propio, devuelve stack + attachments al mazo, baraja y deja reemplazo pendiente si se devuelve el Activo. |
| xy1-116 | Evosoda | Trainer | Item | none | none | Item | `Search your deck for a card that evolves from 1 of your Pokémon and put it onto that Pokémon...` | SEARCH_DECK; SHUFFLE_DECK; CUSTOM_REQUIRED | HIGH | yes | EvosodaEvolveEffectHandler | yes | DATA_IMPORTED; EFFECT_CLASSIFIED; REQUIRES_CUSTOM_HANDLER; EFFECT_MAPPED | no | 11G.3B agrega evolución directa desde mazo con validación `evolvesFrom`, preserva daño/attachments, limpia condiciones por evolución y baraja. |
| xy1-117 | Fairy Garden | Trainer | Stadium | none | none | Stadium | Pokémon con Energía Fairy no tienen coste de retirada. | STADIUM_EFFECT; CONTINUOUS_EFFECT; MODIFY_RETREAT_COST | MEDIUM | yes | ModifierResolver | no | DATA_IMPORTED; EFFECT_CLASSIFIED; EFFECT_SUPPORTED_BY_GENERIC_HANDLER; EFFECT_MAPPED; FULLY_TESTED | yes | Fase 11E.5 mapea/testea el Estadio como `RETREAT_COST SET 0` para Pokémon con Energía Fairy-providing unida. |
| xy1-118 | Great Ball | Trainer | Item | none | none | Item | Mirar top 7 del mazo, revelar un Pokémon opcional y ponerlo en mano; barajar el resto. | SEARCH_DECK; SHUFFLE_DECK; CUSTOM_REQUIRED | HIGH | yes | GreatBallSearchEffectHandler | yes | DATA_IMPORTED; EFFECT_CLASSIFIED; REQUIRES_CUSTOM_HANDLER; EFFECT_MAPPED | no | 11G.3B limita candidatos a Pokémon entre top 7, permite elección opcional, revela el elegido, lo mueve a mano y baraja el mazo restante. |
...
| xy1-120 | Max Revive | Trainer | Item | none | none | Item | `Put a Pokémon from your discard pile on top of your deck.` | MOVE_CARD | MEDIUM | yes | PutDiscardPokemonOnTopDeckEffectHandler | no | DATA_IMPORTED; EFFECT_CLASSIFIED; EFFECT_SUPPORTED_BY_GENERIC_HANDLER; EFFECT_MAPPED; FULLY_TESTED | yes | Fase 11G.3 mueve un Pokémon seleccionado del descarte público al tope del mazo mediante pending selection. |
...
| xy1-122 | Professor Sycamore | Trainer | Supporter | none | none | Supporter rule | `Discard your hand and draw 7 cards.` | DISCARD_CARD; DRAW_CARDS | MEDIUM | yes | DiscardHandDrawEffectHandler | no | DATA_IMPORTED; EFFECT_CLASSIFIED; EFFECT_SUPPORTED_BY_GENERIC_HANDLER; EFFECT_MAPPED; FULLY_TESTED | yes | Fase 11G.3 descarta la mano completa dinámicamente y roba hasta 7. Deck-out por robo de efecto no es derrota en el alcance actual. |
| xy1-123 | Professor's Letter | Trainer | Item | none | none | Item | `Search your deck for up to 2 basic Energy cards, reveal them, and put them into your hand. Shuffle your deck afterward.` | SEARCH_DECK; SHUFFLE_DECK | MEDIUM | partial | SearchDeckEffectHandler; ShuffleDeckEffectHandler; PendingEffectSelection | no | DATA_IMPORTED; EFFECT_CLASSIFIED; EFFECT_SUPPORTED_BY_GENERIC_HANDLER; EFFECT_MAPPED; NOT_IMPLEMENTED_YET | no | Fase 11G.4 lo conserva como mapping interno: pending selection conserva reveal/shuffle metadata, pero falta contrato público seguro para selección de zona oculta y reveal privacy; no marcar FULLY_TESTED. |
| xy1-124 | Red Card | Trainer | Item | none | none | Item | Oponente mezcla su mano en mazo y roba 4. | SHUFFLE_DECK; DRAW_CARDS | MEDIUM | yes | ShuffleHandIntoDeckDrawEffectHandler | no | DATA_IMPORTED; EFFECT_CLASSIFIED; EFFECT_SUPPORTED_BY_GENERIC_HANDLER; EFFECT_MAPPED; FULLY_TESTED | yes | Fase 11G.3 mezcla la mano oculta rival en su mazo sin reveal y roba hasta 4. |
...
| xy1-127 | Shauna | Trainer | Supporter | none | none | Supporter rule | `Shuffle your hand into your deck. Then, draw 5 cards.` | SHUFFLE_DECK; DRAW_CARDS | MEDIUM | yes | ShuffleHandIntoDeckDrawEffectHandler | no | DATA_IMPORTED; EFFECT_CLASSIFIED; EFFECT_SUPPORTED_BY_GENERIC_HANDLER; EFFECT_MAPPED; FULLY_TESTED | yes | Fase 11G.3 mezcla la mano propia en el mazo sin reveal y roba hasta 5. |
| xy1-128 | Super Potion | Trainer | Item | none | none | Item | Cura 60 de 1 Pokémon propio; si cura, descarta una Energía unida a ese Pokémon. | HEAL_DAMAGE; DISCARD_ENERGY; CUSTOM_REQUIRED | MEDIUM | yes | SuperPotionEffectHandler | yes | DATA_IMPORTED; EFFECT_CLASSIFIED; REQUIRES_CUSTOM_HANDLER; EFFECT_MAPPED | no | 11G.3B agrega selección pendiente de Pokémon propio, cura hasta 60 y descarta exactamente una Energía unida, con selección pendiente si hay múltiples Energías. |
...
| xy1-95 | Slurpuff | Pokémon | Stage 1 | Draining Kiss | Sweet Veil | none | Ability: Pokémon propios con Energía Fairy no pueden ser afectados por condiciones especiales; remueve condiciones. Draining Kiss cura 30. | ABILITY_PASSIVE; CONTINUOUS_EFFECT; DAMAGE_PLUS_HEAL | HIGH | partial | HealDamageEffectHandler; ModifierResolver PREVENT_SPECIAL_CONDITION; StatusEffectManager cleanup | yes | DATA_IMPORTED; EFFECT_CLASSIFIED; EFFECT_SUPPORTED_BY_GENERIC_HANDLER; EFFECT_MAPPED; NOT_IMPLEMENTED_YET | no | Sweet Veil está mapeada/testeada para el alcance de habilidad, pero Draining Kiss no tiene mapping/test de carta completa; no marcar FULLY_TESTED. |
| xy1-114 | Furfrou | Pokémon | Basic | Energy Cutoff | Fur Coat | none | Ability: daño hecho a este Pokémon por ataques se reduce 20 después de Debilidad/Resistencia. | ABILITY_PASSIVE; CONTINUOUS_EFFECT; MODIFY_DAMAGE | MEDIUM | partial | CardEffectDefinition; ModifierResolver | no | DATA_IMPORTED; EFFECT_CLASSIFIED; EFFECT_SUPPORTED_BY_GENERIC_HANDLER; EFFECT_MAPPED; NOT_IMPLEMENTED_YET | no | Fur Coat está mapeada/testeada como habilidad continua, pero Energy Cutoff queda pendiente; no marcar carta completa FULLY_TESTED. |
...
| xy1-135 | Lightning Energy | Energy | Basic | none | none | none | Energía Básica Lightning. | BASIC_ENERGY; PROVIDES_ENERGY | LOW | yes | EnergyProfile; EnergyCostValidator | no | DATA_IMPORTED; EFFECT_CLASSIFIED; EFFECT_SUPPORTED_BY_GENERIC_HANDLER; FULLY_TESTED | yes | No requiere mapping textual; provee LIGHTNING estructuralmente. |
| xy1-136 | Psychic Energy | Energy | Basic | none | none | none | Energía Básica Psychic. | BASIC_ENERGY; PROVIDES_ENERGY | LOW | yes | EnergyProfile; EnergyCostValidator | no | DATA_IMPORTED; EFFECT_CLASSIFIED; EFFECT_SUPPORTED_BY_GENERIC_HANDLER; FULLY_TESTED | yes | No requiere mapping textual; provee PSYCHIC estructuralmente. |
| xy1-137 | Fighting Energy | Energy | Basic | none | none | none | Energía Básica Fighting. | BASIC_ENERGY; PROVIDES_ENERGY | LOW | yes | EnergyProfile; EnergyCostValidator | no | DATA_IMPORTED; EFFECT_CLASSIFIED; EFFECT_SUPPORTED_BY_GENERIC_HANDLER; FULLY_TESTED | yes | No requiere mapping textual; provee FIGHTING estructuralmente. |
| xy1-138 | Darkness Energy | Energy | Basic | none | none | none | Energía Básica Darkness. | BASIC_ENERGY; PROVIDES_ENERGY | LOW | yes | EnergyProfile; EnergyCostValidator | no | DATA_IMPORTED; EFFECT_CLASSIFIED; EFFECT_SUPPORTED_BY_GENERIC_HANDLER; FULLY_TESTED | yes | No requiere mapping textual; provee DARKNESS estructuralmente. |
| xy1-139 | Metal Energy | Energy | Basic | none | none | none | Energía Básica Metal. | BASIC_ENERGY; PROVIDES_ENERGY | LOW | yes | EnergyProfile; EnergyCostValidator | no | DATA_IMPORTED; EFFECT_CLASSIFIED; EFFECT_SUPPORTED_BY_GENERIC_HANDLER; FULLY_TESTED | yes | No requiere mapping textual; provee METAL estructuralmente. |
| xy1-140 | Fairy Energy | Energy | Basic | none | none | none | Energía Básica Fairy. | BASIC_ENERGY; PROVIDES_ENERGY | LOW | yes | EnergyProfile; EnergyCostValidator | no | DATA_IMPORTED; EFFECT_CLASSIFIED; EFFECT_SUPPORTED_BY_GENERIC_HANDLER; FULLY_TESTED | yes | No requiere mapping textual; provee FAIRY estructuralmente. |
...
- `EnergyProfile.rainbow()` para representar una Energía flexible que paga exactamente 1 símbolo de cualquier tipo mientras está unida.
...
Infraestructura/mappings agregados en Fase 11G.3:

- `DiscardHandDrawEffectHandler` para Professor Sycamore.
- `ShuffleHandIntoDeckDrawEffectHandler` para Shauna y Red Card, sin revelar contenido de manos ocultas.
- `PutDiscardPokemonOnTopDeckEffectHandler` para Max Revive con pending selection desde descarte público.
- `Professor's Letter` queda completo para alcance interno con selección pendiente, reveal metadata y shuffle metadata.
...
- 11G.3B agrega mappings/handlers internos para `Cassius`, `Evosoda`, `Great Ball` y `Super Potion`; permanecen sin `FULLY_TESTED` hasta ejecutar la suite local y sin contrato público UI/API de selección segura.
