...
| xy1-123 | Professor's Letter | Trainer | Item | none | none | Item | `Search your deck for up to 2 basic Energy cards, reveal them, and put them into your hand. Shuffle your deck afterward.` | SEARCH_DECK; SHUFFLE_DECK | MEDIUM | yes | SearchDeckEffectHandler; ShuffleDeckEffectHandler; PendingEffectSelection | no | DATA_IMPORTED; EFFECT_CLASSIFIED; EFFECT_SUPPORTED_BY_GENERIC_HANDLER; EFFECT_MAPPED; FULLY_TESTED | yes | Fase 11G.3 considera completo el alcance interno: pending selection conserva reveal/shuffle metadata; no expone UI/API pública. |
